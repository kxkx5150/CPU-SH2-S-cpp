...
{
    if ((u32)sh->regs.R[n] > (u32)sh->regs.R[m])
        sh->regs.SR.part.T = 1;
    else
        sh->regs.SR.part.T = 0;
    sh->regs.PC += 2;
...
{
    SH2MappedMemoryWriteByte(sh, sh->regs.R[n] + sh->regs.R[0], sh->regs.R[m]);
    sh->regs.PC += 2;
    sh->cycles++;
}
...
{
    SH2MappedMemoryWriteLong(sh, sh->regs.R[n] + sh->regs.R[0], sh->regs.R[m]);
    sh->regs.PC += 2;
    sh->cycles++;
}
...
{
    SH2MappedMemoryWriteWord(sh, sh->regs.R[n] + sh->regs.R[0], sh->regs.R[m]);
    sh->regs.PC += 2;
    sh->cycles++;
}
