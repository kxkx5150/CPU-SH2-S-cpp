...
static const char vdp1_write_f[] = SHADER_VERSION_COMPUTE
    "#ifdef GL_ES\n"
    "precision highp float;\n"
    "#endif\n"
    "layout(local_size_x = " Stringify(LOCAL_SIZE_X) ", local_size_y = " Stringify(
        LOCAL_SIZE_Y) ") in;\n"
...
static const char vdp1_read_f[] = SHADER_VERSION_COMPUTE
    "#ifdef GL_ES\n"
    "precision highp float;\n"
    "#endif\n"
    "layout(local_size_x = " Stringify(LOCAL_SIZE_X) ", local_size_y = " Stringify(
...
static const char vdp1_clear_f[] = SHADER_VERSION_COMPUTE
    "#ifdef GL_ES\n"
    "precision highp float;\n"
    "#endif\n"
    "layout(local_size_x = " Stringify(LOCAL_SIZE_X) ", local_size_y = " Stringify(
...
static const char vdp1_clear_mesh_f[] = SHADER_VERSION_COMPUTE
    "#ifdef GL_ES\n"
    "precision highp float;\n"
    "#endif\n"
    "layout(local_size_x = " Stringify(LOCAL_SIZE_X) ", local_size_y = " Stringify(
...
static const char vdp1_start_f[] = SHADER_VERSION_COMPUTE
    "#ifdef GL_ES\n"
    "precision highp float;\n"
    "#endif\n"
    ...
    "layout(local_size_x = " Stringify(LOCAL_SIZE_X) ", local_size_y = " Stringify(LOCAL_SIZE_Y) ") in;\n"
                                                                                                 ...
                                                                                                 "  vec2 Quad[4];\n"
                                                                                                 "  if (cmd[idx].type "
                                                                                                 ">= " Stringify(SYSTEM_CLIPPING) ") return 6u;\n"
                                                                                                                                  "//Bounding box test\n"
                                                                                                                                  ...
                                                                                                                                  "  if ((cmd[idx].type == " Stringify(DISTORTED) ") || (cmd[idx].type == " Stringify(POLYGON) ")) {\n"
                                                                                                                                                                                                                               ...
                                                                                                                                                                                                                               "  } else {\n"
                                                                                                                                                                                                                               "    if ((cmd[idx].type == " Stringify(
                                                                                                                                                                                                                                   QUAD) ")  || (cmd[idx].type == " Stringify(QUAD_POLY) ")) {\n"
                                                                                                                                                                                                                                                                                         "     return isOnAQuad(Pin, Quad[0], Quad[2], uv);\n"
                                                                                                                                                                                                                                                                                         "    } else if (cmd[idx].type == " Stringify(
                                                                                                                                                                                                                                                                                             POLYLINE) ") {\n"
                                                                                                                                                                                                                                                                                                       ...
                                                                                                                                                                                                                                                                                                       "    } else if (cmd[idx].type == " Stringify(LINE) ") {\n"
                                                                                                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                                                                                                          "     if (wait_sysclip && (cmd[cmdNb[i]].type != " Stringify(SYSTEM_CLIPPING) ")) continue;"
                                                                                                                                                                                                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                                                                                                                                                                                                        "  texel.y = -texel.y;\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                        "  ivec2 index = ivec2((texel.x*" Stringify(
                                                                                                                                                                                                                                                                                                                                                                                                                                            NB_COARSE_RAST_X) ")/size.x, (texel.y*" Stringify(NB_COARSE_RAST_Y) ")/size.y);\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                "  ivec2 syslimit = sysClip;\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                "  ivec4 userlimit = usrClip;\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                "  uint lindex = index.y*" Stringify(
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    NB_COARSE_RAST_X) "+ index.x;\n"
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      "  uint cmdIndex = lindex * " Stringify(
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          QUEUE_SIZE) "u;\n"
...
static const char vdp1_banding_f[] =
    ...
    "       //MSB shadow\n" MSB_SHADOW(
        finalColor) "      outColor = finalColor;\n"
                    "    } else {\n"
                    ...
                    "           //shadow_mode,\n" SHADOW(
                        finalColor) "          outColor = finalColor;\n"
                                    ...
                                    "        case 2u: {\n"
                                    "           //half_luminance_mode,\n" HALF_LUMINANCE(
                                        newColor) "          outColor = newColor;\n"
                                                  "          }; break;\n"
                                                  "        case 3u: {\n"
                                                  "           //half_trans_mode,\n" HALF_TRANPARENT_MIX(
                                                      newColor,
                                                      finalColor) "          outColor = newColor;\n"
                                                                  "          }; break;\n"
                                                                  "        case 4u: {\n"
                                                                  "           //gouraud_mode,\n" GOURAUD_PROCESS(
                                                                      newColor) "          outColor = newColor;\n"
                                                                                ...
                                                                                "\n" GOURAUD_PROCESS(newColor) RECOLINDEX(newColor) HALF_LUMINANCE(
                                                                                    newColor) "          outColor = "
                                                                                              "newColor;\n"
                                                                                              "          }; break;\n"
                                                                                              "        case 7u: {\n"
                                                      ...
                                                      finalColor) "          outColor = newColor;\n"
                                                                  ...
                                                                  "//gouraud_mode,\n" GOURAUD_PROCESS_EXTENDED(
                                                                      newColor) "          outColor = newColor;\n"
                                                                                ...
                                                                                "//"
                                                                                "gouraud_half_luminance_mode,"
                                                                                "\n" GOURAUD_PROCESS_EXTENDED(newColor) RECOLINDEX(newColor) HALF_LUMINANCE(
                                                                                    newColor) "          outColor = "
                                                                                              "newColor;\n"
                                                                                              "          }; break;\n"
                                                                                              "        case 7u: {\n"
...
static const char vdp1_standard_mesh_f[] = "//Normal mesh\n"
                                           "  tag = vec3(0.0);\n"
...
static const char vdp1_improved_mesh_f[] = "//Improved mesh\n"
                                           "  if ((pixcmd.CMDPMOD & 0x100u)==0x100u){\n"
                                           "    tag.rg = outColor.rg;\n"
                                           "    tag.b = 1.0;\n"
                                           "    outColor = finalColor;\n"
...
static const char vdp1_continue_mesh_f[] = "    if (drawn) {"
                                           "      meshColor.rgb = tag;\n"
                                           "      finalColor = outColor;\n"
                                           "    }\n";

static const char vdp1_continue_no_mesh_f[] = "    if (drawn) {"
                                              "      finalColor = outColor;\n"
                                              "    }\n";
